...
const Icons = {
  ...
  // new icons
  ruler: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12h20"/><path d="M2 17h20"/><path d="M2 7h20"/><path d="M6 12v5"/><path d="M10 12v5"/><path d="M14 12v5"/><path d="M18 12v5"/></svg>,
  scissors: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/></svg>,
...
/* ─── Data — scaled down for a small workshop ─── */
const SEED_MATERIALS = [
  {
    id: 'MAT-001', name: 'Oak Plank 20mm', category: 'Wood', unit: 'm²',
    stock: 8, minStock: 3, maxStock: 20, supplier: 'Bois du Nord',
    price: 2800, location: 'Shelf A1', lastUsed: '2026-07-03', status: 'IN_STOCK',
    usage: [
      { date: '2026-07-03', order: '#2041', worker: 'R. Said', qty: 2, type: 'out' },
      { date: '2026-06-28', order: 'Restock', worker: '—', qty: 10, type: 'in' },
    ],
    leftovers: [
      { id: 'L-001', description: 'Offcut from order #2041', dimensions: '60 × 40 cm', qty: 2, date: '2026-07-03', source: '#2041' },
      { id: 'L-002', description: 'Edge piece', dimensions: '120 × 15 cm', qty: 1, date: '2026-07-01', source: '#2038' },
    ],
  },
  {
    id: 'MAT-002', name: 'MDF Board 18mm', category: 'Wood', unit: 'sheet',
    stock: 6, minStock: 4, maxStock: 15, supplier: 'Placo Algérie',
    price: 1800, location: 'Shelf A2', lastUsed: '2026-07-04', status: 'IN_STOCK',
    usage: [
      { date: '2026-07-04', order: '#2041', worker: 'R. Said', qty: 1, type: 'out' },
    ],
    leftovers: [
      { id: 'L-003', description: 'Half sheet remainder', dimensions: '122 × 60 cm', qty: 1, date: '2026-07-04', source: '#2041' },
    ],
  },
  {
    id: 'MAT-003', name: 'Walnut Veneer', category: 'Veneer', unit: 'm²',
    stock: 0, minStock: 2, maxStock: 8, supplier: 'Bois du Nord',
    price: 4500, location: 'Shelf A3', lastUsed: '2026-06-20', status: 'OUT_OF_STOCK',
    usage: [
      { date: '2026-06-20', order: '#2035', worker: 'M. Draoui', qty: 1, type: 'out' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-004', name: 'Blum Hinge Soft-Close', category: 'Hardware', unit: 'pc',
    stock: 45, minStock: 20, maxStock: 100, supplier: 'Quincaillerie Pro',
    price: 450, location: 'Drawer B1', lastUsed: '2026-07-05', status: 'IN_STOCK',
    usage: [
      { date: '2026-07-05', order: '#2041', worker: 'R. Said', qty: 6, type: 'out' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-005', name: 'Quartz Countertop White', category: 'Stone', unit: 'm²',
    stock: 3, minStock: 2, maxStock: 6, supplier: 'Marbre Elite',
    price: 15000, location: 'Rack C1', lastUsed: '2026-06-30', status: 'IN_STOCK',
    usage: [
      { date: '2026-06-30', order: '#2042', worker: 'R. Said', qty: 1, type: 'out' },
    ],
    leftovers: [
      { id: 'L-004', description: 'Corner cut for future repair', dimensions: '40 × 40 cm', qty: 1, date: '2026-06-30', source: '#2042' },
    ],
  },
  {
    id: 'MAT-006', name: 'Plywood Marine 12mm', category: 'Wood', unit: 'sheet',
    stock: 2, minStock: 3, maxStock: 10, supplier: 'Bois du Nord',
    price: 3200, location: 'Shelf A4', lastUsed: '2026-06-15', status: 'LOW_STOCK',
    usage: [
      { date: '2026-06-15', order: '#2038', worker: 'A. Benali', qty: 1, type: 'out' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-007', name: 'LED Strip Warm White 5m', category: 'Electrical', unit: 'roll',
    stock: 0, minStock: 2, maxStock: 6, supplier: 'Electro Dépôt',
    price: 1200, location: 'Drawer D1', lastUsed: '2026-06-10', status: 'ORDERED',
    usage: [
      { date: '2026-06-10', order: '#2032', worker: 'A. Benali', qty: 1, type: 'out' },
      { date: '2026-07-02', order: 'PO-089', worker: '—', qty: 4, type: 'in' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-008', name: 'Drawer Slide Heavy Duty', category: 'Hardware', unit: 'pair',
    stock: 12, minStock: 8, maxStock: 24, supplier: 'Quincaillerie Pro',
    price: 850, location: 'Drawer B2', lastUsed: '2026-07-02', status: 'IN_STOCK',
    usage: [
      { date: '2026-07-02', order: '#2041', worker: 'R. Said', qty: 2, type: 'out' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-009', name: 'Oak Edge Banding 22mm', category: 'Veneer', unit: 'm',
    stock: 35, minStock: 15, maxStock: 80, supplier: 'Bois du Nord',
    price: 180, location: 'Shelf A5', lastUsed: '2026-07-04', status: 'IN_STOCK',
    usage: [
      { date: '2026-07-04', order: '#2041', worker: 'R. Said', qty: 6, type: 'out' },
    ],
    leftovers: [],
  },
  {
    id: 'MAT-010', name: 'Contact Cement 5L', category: 'Adhesive', unit: 'can',
    stock: 1, minStock: 2, maxStock: 5, supplier: 'Placo Algérie',
    price: 3500, location: 'Shelf E1', lastUsed: '2026-07-01', status: 'LOW_STOCK',
    usage: [
...
/* ─── Status helper — recompute status from stock levels ─── */
...
export default function MaterialsClient() {
  ...
  const [selectedId, setSelectedId] = useState(SEED_MATERIALS[0].id);
  ...
  const emptyForm = {
    name: '', category: 'Wood', unit: 'sheet',
    stock: 0, minStock: 1, maxStock: 10,
    supplier: '', price: 0, location: '',
  };
  const [form, setForm] = useState(emptyForm);
  const [formError, setFormError] = useState('');

  // Add leftover (inline form in the right panel)
  const [showAddLeftover, setShowAddLeftover] = useState(false);
  const [leftoverForm, setLeftoverForm] = useState({ description: '', dimensions: '', qty: 1 });
  ...
  const updateMaterial = (id, patch) => {
    setMaterials(prev => prev.map(m => {
      if (m.id !== id) return m;
      const next = { ...m, ...patch };
      // auto-recompute status when stock changes
      if ('stock' in patch || 'minStock' in patch || 'maxStock' in patch) {
        next.status = computeStatus(next.stock, next.minStock, next.maxStock, next.status === 'ORDERED' ? 'ORDERED' : null);
      }
      return next;
    }));
  };
  ...
  const handleAdjust = (type) => {
    ...
    updateMaterial(selected.id, { stock: newStock });
    setAdjustQty('');
  };

  const handleUseLeftover = (leftoverId) => {
    const leftovers = selected.leftovers.map(l => l.id === leftoverId ? { ...l, qty: l.qty - 1 } : l).filter(l => l.qty > 0);
    updateMaterial(selected.id, { leftovers });
  };

  const handleDeleteLeftover = (leftoverId) => {
    updateMaterial(selected.id, { leftovers: selected.leftovers.filter(l => l.id !== leftoverId) });
  };

  const handleAddLeftover = () => {
    if (!leftoverForm.description.trim() && !leftoverForm.dimensions.trim()) return;
    const id = `L-${Date.now().toString(36).toUpperCase()}`;
    const newLeftover = {
      id,
      description: leftoverForm.description.trim() || 'Manual entry',
      dimensions: leftoverForm.dimensions.trim(),
      qty: Math.max(1, parseInt(leftoverForm.qty) || 1),
      date: new Date().toISOString().slice(0, 10),
      source: 'Manual',
    };
    updateMaterial(selected.id, { leftovers: [...selected.leftovers, newLeftover] });
  ...
  const handleCreateMaterial = () => {
    ...
    if (!form.supplier.trim()) return setFormError('Supplier is required');
    if (form.minStock >= form.maxStock) return setFormError('Min stock must be less than max stock');
    setFormError('');
    ...
    const newMat = {
      ...
      lastUsed: '—',
      status: computeStatus(form.stock, form.minStock, form.maxStock, null),
      usage: [],
      leftovers: [],
    };
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {(lowStockCount > 0 || outStockCount > 0) && (
          <div
            ...
            style={{ background: 'var(--accent-soft)', borderBottom: '1px solid rgba(254,189,17,0.2)' }}
          >
            <Icons.alert />
        ...
        >
          <div
            ...
            style={{ background: 'var(--bg)', border: '1px solid var(--border)', width: 240 }}
          >
            <Icons.search />
            <input
              value={search}
          ...
          <table className="w-full text-left text-sm">
            <thead className="sticky top-0 z-10" style={{ background: 'var(--surface-2)' }}>
              <tr>
                ...
                <th className="px-4 py-3 text-xs font-medium" style={{ color: 'var(--ink-muted)' }}>Leftovers</th>
            ...
            <tbody>
              {filtered.map(m => {
                ...
                const leftoverCount = m.leftovers.reduce((s, l) => s + l.qty, 0);
                return (
                  <tr
                    key={m.id}
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="mt-1 h-1 w-16 rounded-full overflow-hidden" style={{ background: 'var(--surface-2)' }}>
                        <div className="h-full rounded-full" style={{
                          width: `${stockPct}%`,
                          background: m.status === 'OUT_OF_STOCK' ? 'var(--stage-contract)' : m.status === 'LOW_STOCK' ? 'var(--accent)' : 'var(--stage-completed)',
                        }} />
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      {leftoverCount > 0 ? (
                        <span className="inline-flex items-center gap-1.5 text-xs font-medium" style={{ color: 'var(--ink-muted)' }}>
                          <Icons.ruler />
                          <span className="tabular-nums">{leftoverCount}</span>
                          <span>piece{leftoverCount > 1 ? 's' : ''}</span>
                        </span>
                      ) : (
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={9} className="px-4 py-12 text-center text-sm" style={{ color: 'var(--ink-muted)' }}>No materials match your filters.</td></tr>
              )}
            </tbody>
          </table>
        </div>
      ...
      >
        ...
        <div className="p-5 space-y-3" style={{ borderBottom: '1px solid var(--border)' }}>
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-semibold uppercase tracking-wider flex items-center gap-2" style={{ color: 'var(--ink-muted)' }}>
              <Icons.ruler /> Leftovers
              <span className="px-1.5 py-0.5 rounded text-[10px] tabular-nums" style={{ background: 'var(--bg)', color: 'var(--ink-muted)', border: '1px solid var(--border)' }}>
          ...
          {showAddLeftover && (
            <div className="p-3 rounded-lg space-y-2" style={{ background: 'var(--bg)', border: '1px solid var(--border)' }}>
              <input
                value={leftoverForm.description}
                onChange={e => setLeftoverForm(f => ({ ...f, description: e.target.value }))}
                placeholder="Description (e.g. Offcut, leftover plank)"
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={e => setLeftoverForm(f => ({ ...f, dimensions: e.target.value }))}
                ...
                <input
                  ...
                  onChange={e => setLeftoverForm(f => ({ ...f, qty: e.target.value }))}
                  className="w-16 px-2.5 py-1.5 rounded text-xs outline-none focus-ring tabular-nums text-center"
                  style={inputStyle}
                />
              </div>
              <div className="flex gap-2 justify-end">
                <button onClick={() => { setShowAddLeftover(false); setLeftoverForm({ description: '', dimensions: '', qty: 1 }); }} className="btn-ghost text-xs px-3 py-1">Cancel</button>
                <button onClick={handleAddLeftover} className="btn-primary text-xs px-3 py-1"><Icons.plus /> Save</button>
              </div>
            </div>
          )}

          {selected.leftovers.length === 0 ? (
            <div className="text-center py-6 text-xs" style={{ color: 'var(--ink-muted)' }}>
              No leftovers yet. Log cut-offs manually so nothing goes to waste.
            </div>
          ) : (
              ...
              {selected.leftovers.map(l => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs flex items-center gap-1.5" style={{ color: 'var(--ink-muted)' }}>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-bold tabular-nums px-2 py-0.5 rounded" style={{ background: 'var(--surface-2)' }}>
                      ×{l.qty}
                    </span>
                    <button
                      onClick={() => handleUseLeftover(l.id)}
                      className="btn-primary text-xs px-2.5 py-1.5"
                      title="Use one (reduces from leftovers)"
                    >
                      <Icons.scissors /> Use
                    </button>
                    <button
                      onClick={() => handleDeleteLeftover(l.id)}
              ...
              {selected.usage.map((u, i) => (
                <div key={i} className="flex items-center gap-3 p-3 rounded-lg" style={{ background: 'var(--bg)', border: '1px solid var(--border)' }}>
                  <div
                    ...
                    style={{ background: 'var(--surface-2)', color: u.type === 'in' ? 'var(--stage-completed)' : 'var(--accent)' }}
                  >
                  ...
                  <div className="text-sm font-bold tabular-nums" style={{ color: u.type === 'in' ? 'var(--stage-completed)' : 'var(--accent)' }}>
                    {u.type === 'in' ? '+' : '-'}{u.qty}
                  </div>
                </div>
              ))}
        ...
        <Modal
          ...
          footer={
            <>
              ...
              <button onClick={handleCreateMaterial} className="btn-primary px-4 text-sm"><Icons.plus /> Create</button>
            </>
          }
        >
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Max Stock" hint="Full capacity">
              <input
                ...
                min="1"
                value={form.maxStock}
                onChange={e => setForm(f => ({ ...f, maxStock: parseInt(e.target.value) || 1 }))}
                className="px-3 py-2 rounded-md text-sm outline-none focus-ring tabular-nums"
                style={inputStyle}
              />
            </Field>
          ...
          <div className="mt-5 p-3 rounded-lg flex items-center justify-between" style={{ background: 'var(--bg)', border: '1px solid var(--border)' }}>
            <span className="text-xs" style={{ color: 'var(--ink-muted)' }}>Computed status</span>
            <StageBadge stage={computeStatus(form.stock, form.minStock, form.maxStock, null)} />
          </div>
        </Modal>
      )}
    </div>
